...
const pool = new Pool({
    user: process.env.DB_USER || 'your_postgres_user',       // Имя пользователя вашей базы данных PostgreSQL
    host: process.env.DB_HOST || 'localhost',                 // Хост вашей базы данных (например, 'localhost' или IP-адрес)
    database: process.env.DB_NAME || 'schedule_db',           // Имя вашей базы данных
    password: process.env.DB_PASSWORD || 'your_postgres_password', // Пароль пользователя базы данных
