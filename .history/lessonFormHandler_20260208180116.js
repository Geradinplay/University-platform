...
import { createLesson } from './mockApi.js'; // ИЗМЕНЕНО: теперь используем mockApi.js
...
export async function addNewLesson() { // Делаем функцию асинхронной
    ...
    const lessonData = {
        ...
        time: tm, // Время в формате ЧЧ:ММ-ЧЧ:ММ
    ...
    try {
        ...
        d.ondragover = window.allowDrop; // Добавлено
        ...
        `;
        document.getElementById('buffer-container').appendChild(d); // ИЗМЕНЕНО: ID буфера
