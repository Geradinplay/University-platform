...
export async function updateSubject(subjectId, dataToUpdate) {
    try {
...
export async function updateProfessor(professorId, dataToUpdate) {
    try {
        const response = await fetch(`${API_BASE_URL}/api/professors/${professorId}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(dataToUpdate),
        });
        ...
        console.error(`Error updating professor ${professorId}:`, error);
        throw error;
    }
}
...
export async function deleteProfessor(professorId) {
    try {
        ...
        console.error(`Error deleting professor ${professorId}:`, error);
        throw error;
    }
}
...
export async function updateClassroom(classroomId, dataToUpdate) {
    try {
