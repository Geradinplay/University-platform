function renderLesson(lesson) {
  ...
  lessonEl.addEventListener("dragstart", drag);
  lessonEl.addEventListener("dragend", dragEnd);
  lessonEl.addEventListener("dragover", dragOver);
  lessonEl.addEventListener("drop", drop);
  lessonEl.addEventListener("dragleave", dragLeave);
  
  return lessonEl;
}

export function renderSchedule(lessons, container) {
  container.innerHTML = "";
